...
print(hR.getExtJointTorques(s, BUFFER_SIZE)[0][6])
i = 0
X=[]
Y0=[]
Y1=[]
...
while i < Lang and no_collsion:
    ...
    i = i+0.1
    X.append(i)
    Y0.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][0])
    Y1.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][1])
    Y2.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][2])
    Y3.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][3])
    Y4.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][4])
    Y5.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][5])
    Y6.append(hR.getExtJointTorques(s, BUFFER_SIZE)[0][6])
